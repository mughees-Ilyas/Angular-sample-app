 ...
 */
  onSubmit() {
    ...
    let data =   { id: Date.now(), username: this.f.firstName.value, password: this.f.firstName.value, firstName: this.f.firstName.value, lastName: this.f.lastName.value, address:this.f.address.value, dob:dateOfbirth };
